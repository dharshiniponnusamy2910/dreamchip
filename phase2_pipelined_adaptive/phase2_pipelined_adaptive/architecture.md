...
This structure allows adaptive execution without modifying the architectural ISA, while keeping the additional hardware primarily in the control path so that adaptation overhead can be measured explicitly.
